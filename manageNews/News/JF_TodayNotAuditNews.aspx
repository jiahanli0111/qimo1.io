...
<%@ Page CodeBehind="JF_TodayNotAuditNews.aspx.cs" Language="c#" AutoEventWireup="false" Inherits="JFCmsEnterprise.manageNews.News.JF_TodayNotAuditNews" %>
	...
	<body topMargin="0">
		<FONT face="宋体">
			<form id="Form1" method="post" runat="server">
				<FIELDSET style="WIDTH: 100%" align="center"><LEGEND><B>今日未审核新闻</B></LEGEND>
								...
								<TR class="category_menu" onMouseOver="this.style.backgroundColor='#E6F5FA'" onMouseOut="this.style.backgroundColor='#FFFFFF'">
									...
									<TD noWrap width="5%">
										<a href='javascript:' onclick='newwin("JF_ReviewManage.aspx?NewsID=<%#DataBinder.Eval(Container.DataItem,"NewsID")%>","review","700","620")'>
											评论管理</a></TD>
									<TD noWrap width="1%"></TD>
									<TD noWrap width="9%"><a href='JF_EditNews.aspx?CategoryID=<%#DataBinder.Eval(Container.DataItem,"CategoryID")%>&NewsID=<%# DataBinder.Eval(Container.DataItem,"NewsID")%>&FromUrl=JF_TodayNotAuditNews.aspx'>修改</a>|<a href='?action=DelNews&NewsID=<%# DataBinder.Eval(Container.DataItem,"NewsID")%>&DatePath=<%# DataBinder.Eval(Container.DataItem,"DatePath")%>&FileName=<%# DataBinder.Eval(Container.DataItem,"FileName")%>' onClick="return Del()">删除</a>|
