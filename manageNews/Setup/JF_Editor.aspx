...
<%@ Page CodeBehind="JF_Editor.aspx.cs" Language="c#" AutoEventWireup="false" Inherits="JFCmsEnterprise.manageNews.Setup.JF_Editor" %>
		...
		<FONT face="宋体">
			<form id="Form1" method="post" runat="server">
				...
				<table cellSpacing="0" width="95%" align="center" border="0">
					<tr>
						<td vAlign="top" align="center" width="41%"><asp:panel id="ep_add" Runat="server">
								<TABLE id="Table6" cellSpacing="0" cellPadding="0" width="84%" border="0">
									<TR>
										<TD colSpan="2" height="8"></TD>
									</TR>
									<TR>
										<TD colSpan="8" height="1">增加责任编辑</TD>
									</TR>
									<TR bgColor="#808080">
									...
									<TR class="category_menu">
										...
										<TD noWrap>
											<asp:TextBox id="EditorName" runat="server"></asp:TextBox>
											<asp:Button id="e_add" runat="server" Text="添加"></asp:Button></TD>
									</TR>
								</TABLE>
								...
								<TABLE id="Table6" cellSpacing="0" cellPadding="0" width="84%" border="0">
									...
									<TR>
										<TD colSpan="8" height="1">修改责任编辑</TD>
									</TR>
									<TR bgColor="#808080">
										<TD bgColor="#cccccc" colSpan="8" height="1"></TD>
									</TR>
									...
									<TR class="category_menu">
										...
										<TD noWrap>
											<asp:TextBox id="m_EditorName" runat="server"></asp:TextBox>
											<asp:Button id="e_modify" runat="server" Text="修改"></asp:Button></TD>
									</TR>
								</TABLE>
							</asp:panel></td>
						<td vAlign="top" width="59%">
							<TABLE id="Table6" cellSpacing="0" cellPadding="0" width="84%" border="0">
								...
								<TR class="category_menu">
									...
									<TD noWrap width="214" background="../images/tableheadingback.gif">编辑名称</TD>
									<TD vAlign="top" noWrap width="6" background="../images/tableheadingback.gif"><IMG height="17" src="../images/tableheadingsep.gif" width="6" valign="top"></TD>
								...
								<asp:repeater id="list_editor" runat="server">
									<ItemTemplate>
										<TR class="category_menu" onmouseover="this.style.backgroundColor='#E6F5FA'" onmouseout="this.style.backgroundColor='#FFFFFF'"
											bgcolor="#FFFFFF">
											<TD noWrap width="53"><IMG height="0" src="" width="5">&nbsp;<%#DataBinder.Eval(Container.DataItem,"ID")%></TD>
											<TD noWrap width="6"></TD>
											<TD noWrap><%#DataBinder.Eval(Container.DataItem,"EditorName")%></TD>
											<TD noWrap width="6"></TD>
											<TD noWrap><%#DataBinder.Eval(Container.DataItem,"DateAndTime","{0:yyyy/MM/dd  HH:mm}")%></TD>
											<TD noWrap width="6"></TD>
											<TD width="28" noWrap><a href='JF_Editor.aspx?action=md&id=<%#DataBinder.Eval(Container.DataItem,"id")%>&page=<%=Request.QueryString["page"]%>'>修改</a></TD>
											<TD width="20" noWrap><input type='checkbox' name='delid' value='<%#DataBinder.Eval(Container.DataItem,"id")%>'></TD>
										</TR>
										<TR class="category_menu" onmouseover="this.style.backgroundColor='#E6F5FA'" onmouseout="this.style.backgroundColor='#FFFFFF'">
							...
							<table cellSpacing="0" cellPadding="0" width="84%" border="0">
								<tr>
									<td align="right" width="96%"><asp:button CssClass="button" id="e_del" runat="server" Text="删除"></asp:button>全选
									</td>
