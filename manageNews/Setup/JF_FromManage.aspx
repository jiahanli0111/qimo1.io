<%@ Page CodeBehind="JF_FromManage.aspx.cs" Language="c#" AutoEventWireup="false" Inherits="JFCmsEnterprise.manageNews.Setup.JF_FromManage" %>
							...
							<TABLE id="Table5" cellSpacing="0" cellPadding="0" width="100%" border="0">
								...
								<TR>
									...
									<TD vAlign="bottom" align="left" width="100%" background="../images/backheading.gif"
										height="24"><SPAN class="tdtoptitle">内容来源</SPAN></TD>
					...
					<tr>
						<td vAlign="top" align="center" width="39%"><asp:panel id="ep_add" Runat="server">
								<TABLE id="Table6" cellSpacing="0" cellPadding="0" width="84%" border="0">
									...
									<TR>
										<TD colSpan="8" height="1">增加内容来源</TD>
									</TR>
									<TR bgColor="#808080">
									...
									<TR class="category_menu">
										...
										<TD noWrap>
											<asp:TextBox id="FromName" runat="server"></asp:TextBox></TD>
									</TR>
									<TR class="category_menu">
										<TD noWrap>来源地址:
										</TD>
										<TD noWrap>
											<asp:TextBox id="FromPath" runat="server">http://</asp:TextBox>
											<asp:Button id="f_add" runat="server" Text="添加"></asp:Button></TD>
									</TR>
								</TABLE>
								...
								<TABLE id="Table6" cellSpacing="0" cellPadding="0" width="84%" border="0">
									...
									<TR>
										<TD colSpan="8" height="1">修改内容来源</TD>
									</TR>
									<TR bgColor="#808080">
										<TD bgColor="#cccccc" colSpan="8" height="1"></TD>
									</TR>
									...
									<TR class="category_menu">
										...
										<TD noWrap>
											<asp:TextBox id="f_FromName" runat="server"></asp:TextBox></TD>
									</TR>
									<TR class="category_menu">
										<TD noWrap>来源地址:
										</TD>
										<TD noWrap>
											<asp:TextBox id="f_FromPath" runat="server"></asp:TextBox>
											<asp:Button id="f_modify" runat="server" Text="修改"></asp:Button></TD>
									</TR>
								</TABLE>
							</asp:panel></td>
						<td vAlign="top" width="61%">
							<TABLE id="Table6" cellSpacing="0" cellPadding="0" width="84%" border="0">
								...
								<TR class="category_menu">
									...
									<TD noWrap width="214" background="../images/tableheadingback.gif">来源名称</TD>
									<TD vAlign="top" noWrap width="6" background="../images/tableheadingback.gif"><IMG height="17" src="../images/tableheadingsep.gif" width="6" valign="top"></TD>
								...
								<asp:repeater id="list_editor" runat="server">
									<ItemTemplate>
										<TR class="category_menu" onmouseover="this.style.backgroundColor='#E6F5FA'" onmouseout="this.style.backgroundColor='#FFFFFF'"
											bgcolor="#FFFFFF">
											<TD noWrap width="53"><IMG height="0" src="" width="5">&nbsp;<%#DataBinder.Eval(Container.DataItem,"FromID")%></TD>
											<TD noWrap width="6"></TD>
											<TD noWrap><a href='<%#DataBinder.Eval(Container.DataItem,"FromPath")%>' target='_blank'><%#DataBinder.Eval(Container.DataItem,"FromName")%></a></TD>
											<TD noWrap width="6"></TD>
											<TD noWrap><%#DataBinder.Eval(Container.DataItem,"DateAndTime","{0:yyyy/MM/dd  HH:mm}")%></TD>
											<TD noWrap width="6"></TD>
											<TD width="28" noWrap><a href='JF_FromManage.aspx?action=md&FromID=<%#DataBinder.Eval(Container.DataItem,"FromID")%>&page=<%=Request.QueryString["page"]%>'>修改</a></TD>
											<TD width="20" noWrap><input type='checkbox' name='delid' value='<%#DataBinder.Eval(Container.DataItem,"FromID")%>'></TD>
										</TR>
										<TR class="category_menu" onmouseover="this.style.backgroundColor='#E6F5FA'" onmouseout="this.style.backgroundColor='#FFFFFF'">
							...
							<table cellSpacing="0" cellPadding="0" width="84%" border="0">
								<tr>
									<td align="right" width="96%"><asp:button class="button" id="f_del" runat="server" Text="删除"></asp:button>全选
									</td>
