<%@ Page CodeBehind="JF_Ads_Hour_Depict.aspx.cs" Language="c#" AutoEventWireup="false" Inherits="JFCmsEnterprise.manageNews.Ads.JF_Ads_Hour_Depict" %>
					...
					<TR>
						<TD width="100%" vAlign="top" class=""><table width="500" border="0" align="center" cellpadding="0" cellspacing="0" id="Table1">
								<tr>
									...
									<td width="65" height="26" align="center" valign="middle" background="../Images/ads/Adstoobar-1.GIF"><a href="JF_Ads_Hour_Depict.aspx?AdsID=<%=AdsID%>&AdsCategoryID=<%=AdsCategoryID%>"><font color="#ffffff"><strong>时报表</strong></font></a></td>
								...
								<tr bgcolor="#ffffff" onMouseOver="this.style.backgroundColor='#FAFBFC';" onMouseOut="this.style.backgroundColor='';"
									...
									<td colspan="2"><table width="100%" border="0" align="center" cellspacing="0">
											<tr valign="bottom">
												...
												<asp:Repeater ID="list_hour_show" Runat="server">
													<ItemTemplate>
														<td rowspan="4" align="center">
															<img src="../images/Ads/point_top.gif" width="14" height='2' title='(<%#DataBinder.Eval(Container.DataItem,"hour")%>时) 显示量：<%#DataBinder.Eval(Container.DataItem,"total")%>'><br>
															<img src="../images/Ads/point.gif" width='14' height='<%#DataBinder.Eval(Container.DataItem,"Width")%>' title='(<%#DataBinder.Eval(Container.DataItem,"hour")%>时) 显示量：<%#DataBinder.Eval(Container.DataItem,"total")%>'><br>
															<img src="../images/Ads/point_bottom.gif" width="14" height='2' title='(<%#DataBinder.Eval(Container.DataItem,"hour")%>时) 显示量：<%#DataBinder.Eval(Container.DataItem,"total")%>'><br>
															<%#DataBinder.Eval(Container.DataItem,"hour")%><br>
														</td>
													</ItemTemplate>
												</asp:Repeater>
									...
									<td colspan="2">
										<table width="100%" border="0" align="center" cellspacing="0">
											<tr valign="bottom">
												...
												<asp:Repeater ID="list_hour_click" Runat="server">
													<ItemTemplate>
														<td rowspan="4" align="center">
															<img src="../images/Ads/point_top.gif" width="14" height='2' title='(<%#DataBinder.Eval(Container.DataItem,"hour")%>时) 点击量：<%#DataBinder.Eval(Container.DataItem,"total")%>'><br>
															<img src="../images/Ads/point.gif" width='14' height='<%#DataBinder.Eval(Container.DataItem,"Width")%>' title='(<%#DataBinder.Eval(Container.DataItem,"hour")%>时) 点击量：<%#DataBinder.Eval(Container.DataItem,"total")%>'><br>
															<img src="../images/Ads/point_bottom.gif" width="14" height='2' title='(<%#DataBinder.Eval(Container.DataItem,"hour")%>时) 点击量：<%#DataBinder.Eval(Container.DataItem,"total")%>'><br>
															<%#DataBinder.Eval(Container.DataItem,"hour")%><br>
														</td>
													</ItemTemplate>
												</asp:Repeater>
									...
									<td colspan="2">
										<table width="100%" border="0" align="center" cellspacing="0">
											<tr valign="bottom">
												...
												<asp:Repeater ID="list_hour_average" Runat="server">
													<ItemTemplate>
														<td rowspan="4" align="center">
															<img src="../images/Ads/point_top.gif" width="14" height='2' title='(<%#DataBinder.Eval(Container.DataItem,"hour")%>时) 点击率：<%#DataBinder.Eval(Container.DataItem,"total")%>'><br>
															<img src="../images/Ads/point.gif" width='14' height='<%#DataBinder.Eval(Container.DataItem,"Width")%>' title='(<%#DataBinder.Eval(Container.DataItem,"hour")%>时) 点击率：<%#DataBinder.Eval(Container.DataItem,"total")%>'><br>
															<img src="../images/Ads/point_bottom.gif" width="14" height='2' title='(<%#DataBinder.Eval(Container.DataItem,"hour")%>时) 点击率：<%#DataBinder.Eval(Container.DataItem,"total")%>'><br>
															<%#DataBinder.Eval(Container.DataItem,"hour")%><br>
														</td>
													</ItemTemplate>
												</asp:Repeater>
