<%@ Page CodeBehind="JF_Ads_Day_Depict.aspx.cs" Language="c#" AutoEventWireup="false" Inherits="JFCmsEnterprise.manageNews.Ads.JF_Ads_Day_Depict" %>
	...
	<body>
		<form id="Form1" method="post" runat="server">
			<TABLE class="" id="tb" cellSpacing="0" cellPadding="0" width="100%" border="0" name="tb">
				<TBODY>
					<TR>
						<TD width="100%" vAlign="top"><table width="500" border="0" align="center" cellpadding="0" cellspacing="0" id="Table1">
								<tr>
									...
									<td width="65" height="26" align="center" background="../Images/ads/Adstoobar-1.GIF"><font color="#ffffff"><strong>日报表</strong></font></A></td>
									<td width="3"><img src="../Images/ads/Adstoobar-3.GIF" width="3" height="26"></td>
								...
								<tr bgcolor="#ffffff" onMouseOver="this.style.backgroundColor='#FAFBFC';" onMouseOut="this.style.backgroundColor='';"
									...
									<td colspan="2"><table width="100%" border="0" align="center" cellspacing="0">
											<tr valign="bottom">
												...
												<asp:Repeater ID="list_day_show" Runat="server">
													<ItemTemplate>
														<td rowspan="4" align="center">
															<img src="../images/Ads/point_top.gif" width="14" height='2' title='(<%#DataBinder.Eval(Container.DataItem,"day")%>日) 显示量：<%#DataBinder.Eval(Container.DataItem,"total")%>'><br>
															<img src="../images/Ads/point.gif" width='14' height='<%#DataBinder.Eval(Container.DataItem,"Width")%>' title='(<%#DataBinder.Eval(Container.DataItem,"day")%>日) 显示量：<%#DataBinder.Eval(Container.DataItem,"total")%>'><br>
															<img src="../images/Ads/point_bottom.gif" width="14" height='2' title='(<%#DataBinder.Eval(Container.DataItem,"day")%>日) 显示量：<%#DataBinder.Eval(Container.DataItem,"total")%>'><br><%#DataBinder.Eval(Container.DataItem,"day")%><br>
															</td>
													</ItemTemplate>
												</asp:Repeater>
											</tr>
									...
									<td colspan="2">
										<table width="100%" border="0" align="center" cellspacing="0">
											<tr valign="bottom">
												...
												<asp:Repeater ID="list_day_click" Runat="server">
													<ItemTemplate>
														<td rowspan="4" align="center">
															<img src="../images/Ads/point_top.gif" width="14" height='2' title='(<%#DataBinder.Eval(Container.DataItem,"day")%>日) 点击量：<%#DataBinder.Eval(Container.DataItem,"total")%>'><br>
															<img src="../images/Ads/point.gif" width='14' height='<%#DataBinder.Eval(Container.DataItem,"Width")%>' title='(<%#DataBinder.Eval(Container.DataItem,"day")%>日) 点击量：<%#DataBinder.Eval(Container.DataItem,"total")%>'><br>
															<img src="../images/Ads/point_bottom.gif" width="14" height='2' title='(<%#DataBinder.Eval(Container.DataItem,"day")%>日) 点击量：<%#DataBinder.Eval(Container.DataItem,"total")%>'><br><%#DataBinder.Eval(Container.DataItem,"day")%><br>
														</td>
													</ItemTemplate>
												</asp:Repeater>
											</tr>
									...
									<td colspan="2">
										<table width="100%" border="0" align="center" cellspacing="0">
											<tr valign="bottom">
												...
												<asp:Repeater ID="list_day_average" Runat="server">
													<ItemTemplate>
														<td rowspan="4" align="center">
															<img src="../images/Ads/point_top.gif" width="14" height='2' title='(<%#DataBinder.Eval(Container.DataItem,"day")%>日) 点击率：<%#DataBinder.Eval(Container.DataItem,"total")%>'><br>
															<img src="../images/Ads/point.gif" width='14' height='<%#DataBinder.Eval(Container.DataItem,"Width")%>' title='(<%#DataBinder.Eval(Container.DataItem,"day")%>日) 点击率：<%#DataBinder.Eval(Container.DataItem,"total")%>'><br>
															<img src="../images/Ads/point_bottom.gif" width="14" height='2' title='(<%#DataBinder.Eval(Container.DataItem,"day")%>日) 点击率：<%#DataBinder.Eval(Container.DataItem,"total")%>'><br><%#DataBinder.Eval(Container.DataItem,"day")%><br>
														</td>
													</ItemTemplate>
												</asp:Repeater>
											</tr>
									...
									<td height="30" colspan="2" onMouseOver="this.style.backgroundColor='#FAFBFC';" onMouseOut="this.style.backgroundColor='';"
										this.style.cursor='hand'><TABLE width="500" height="120" border="0" align="center" cellPadding="0" cellSpacing="0">
											...
											<tr>
												...
												<td width="325">&nbsp;
													<asp:RadioButton id="CurrentMonth" runat="server" Text="本月" GroupName="Condition"></asp:RadioButton></td>
